...
import app.appworks.school.stylish.databinding.ItemColorAnalysisSizeBinding
 ...
 */
class ColorAnalysisSizeAdapter(val viewModel: ColorAnalysisViewModel) : ListAdapter<Variant, ColorAnalysisSizeAdapter.SizeViewHolder>(DiffCallback) {

    private lateinit var context: Context

    class SizeViewHolder(
        private val binding: ItemColorAnalysisSizeBinding,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SizeViewHolder {
        ...
        return SizeViewHolder(
            ItemColorAnalysisSizeBinding.inflate(LayoutInflater.from(parent.context), parent, false),
            viewModel
        )
    }
